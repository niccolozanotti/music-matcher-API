...
async def context_getter(request: Request):
    '''Returns the object representing the context. request Parameter is the GraphQL request, including the GraphQL operation, any HTTP headers and spotify_client object.
    '''
